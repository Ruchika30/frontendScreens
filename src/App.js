...
import BlogIdProvider from './context/blogIdProvider';
            ...
            <Switch>
              <BlogIdProvider>
                <CareerIdValueProvider>
                  ...
                  <Route exact path="/blog/:categoryName" component={CategoryPage} />
                  <Route exact path="/blog/:categoryName/:articleName/" component={CategoryPage} />
                  <Route exact path="/blog/:categoryName/:articleName/:blogId" component={BlogPage} />
